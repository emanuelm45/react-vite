...
export default function () {
    ...
    return <>
        <div className="input-container">
            ...
            <select onChange={selectState} value={uf} id="select-states">
                {uf ? "" : <option>Selecione...</option>}
                {states.map(({ sigla, nome }, idx) => <option id={sigla} key={idx} value={sigla}>{sigla} - {nome}</option>)}
            </select>
        </div>
    </>
}